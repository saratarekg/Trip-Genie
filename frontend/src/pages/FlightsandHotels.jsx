  ...
  useEffect(() => {
    ...
    if (new Date(hotelForm.checkOut) <= new Date(hotelForm.checkIn)) {
      setHotelForm((prev) => ({
        ...prev,
        checkOut: formatDate(
          new Date(new Date(prev.checkIn).getTime() + 86400000)
        ),
      }));
    }
          ...
          <form onSubmit={handleFlightSearch} style={styles.form}>
            <div style={styles.fieldGroup}>
              ...
              <select
                ...
                value={tripType}
                onChange={(e) =>
                  handleFieldClick() && setTripType(e.target.value)
                }
              >
            ...
            <div style={styles.fieldGroup}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  onChange={(e) =>
                    handleFieldClick() &&
                    setFlightForm({ ...flightForm, departDate: e.target.value })
                  }
                  required
                />
              ...
              <div style={styles.locationDisplay}>
                {new Date(flightForm.departDate).toLocaleDateString("en-US", {
                  weekday: "short",
                  day: "2-digit",
                  month: "short",
                })}
            ...
            {tripType === "roundTrip" && (
              <div style={styles.fieldGroup}>
                ...
                <div style={styles.locationDisplay}>
                  {new Date(flightForm.returnDate).toLocaleDateString("en-US", {
                    weekday: "short",
                    day: "2-digit",
                    month: "short",
                  })}
