...
import { Activity, ShoppingCart, Plane, Hotel, Calendar, Wallet, Award, Bell, ShoppingBasket,CheckCircle, XCircle, Bus, Map, User, Car } from 'lucide-react'
...
const TouristWalletPage = () => {
    ...
    return (
      ...
      <p className="text-sm text-gray-500 mb-2">Settings and Privacy  / Wallet History</p>
            <WalletHistory 
      tourist={tourist}
