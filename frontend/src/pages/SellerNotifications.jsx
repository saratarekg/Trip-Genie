    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-5xl mx-auto px-4 py-6">
            ...
            {notifications.length === 0 ? (
                <p className="text-[#1A3B47] bg-gray-100 p-4 rounded-lg shadow text-center">No notifications at the moment.</p>
            ) : (
                    ...
                    <table className="w-full border-collapse border border-gray-200 shadow-sm rounded-lg">
                        <thead>
                            <tr className="bg-gray-100 text-[#1A3B47]">
                                <th className="px-4 py-2 text-left text-2xl border-b border-gray-200">Notification</th>
                                <th className="px-4 py-2 text-left text-2xl border-b border-gray-200">Date</th>
                            </tr>
                        </thead>
                        <tbody>
