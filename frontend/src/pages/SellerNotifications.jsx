...
import { Bell, Gift,XCircle,CheckCircle, CreditCard, AlertCircle, CheckCheck, AlarmCheck, Loader2, Search, Filter, ChevronDown, X, Calendar as CalendarIcon } from 'lucide-react'
  ...
  const getFilteredNotifications = () => {
    ...
    switch (activeTab) {
      case "reminders":
        ...
        break
      case "alert":
        filtered = filtered.filter(n.tags.some(tag => ["warning", "alert"].includes(tag)))
        break
      case "general":
        break
    }
