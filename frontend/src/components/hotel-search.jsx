...
export default function HotelSearch() {
            ...
            <Select value={priceFilter} onValueChange={setPriceFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="under25">
                  Under {userCurrency.symbol}{Math.floor(0.25 * convertPrice(maxPrice))}
                </SelectItem>
                <SelectItem value="under50">
                  Under {userCurrency.symbol}{Math.floor(0.5 * convertPrice(maxPrice))}
                </SelectItem>
                <SelectItem value="under75">
                  Under {userCurrency.symbol}{Math.floor(0.75 * convertPrice(maxPrice))}
                </SelectItem>
                <SelectItem value="over75">
                  Over {userCurrency.symbol}{Math.floor(0.75 * convertPrice(maxPrice))}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
  ...
  {hotels.length === 0 ? (
    <div className="col-span-2 text-xl text-center text-gray-600 mt-8 pt-5">
      <p>No hotels found. Please adjust your search criteria and try again.</p>
    </div>
  ) : (
