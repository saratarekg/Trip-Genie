    ...
    const fetchData = async () => {
      try {
        ...
        const optionsData = {
          ...
          historicalPeriods: histPeriodsRes.data.map((period) => ({
            value: period,
            label: period,
          })),
        };
        ...
        const formattedPrefs = {
          ...
          historicalPlacePeriod:
            prefsRes.data.historicalPlacePeriod?.map((period) =>
              optionsData.historicalPeriods.find((o) => o.value === period)
            ) || null,
        };
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const updatedData = {
        ...
        historicalPlacePeriod:
          data.historicalPlacePeriod?.map((item) => item.value) || [],
      };
        ...
        <div className="space-y-4">
          ...
          <Controller
            ...
            render={({ field }) => (
              <div>
                <Label
                  htmlFor="historicalPlacePeriod"
                  className="text-sm font-medium text-gray-600 mb-1"
                >
                  Historical Place Period
                </Label>
                <Select
                  {...field}
                  isMulti
