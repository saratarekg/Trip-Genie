...
const ProductReport = () => {
  ...
  useEffect(() => {
    if (salesReport) {
      ...
      setSelectedPeriodRevenue(calculatePeriodRevenue(salesReport.adminProductsSales, selectedPeriod));
    }
  ...
  const thisMonthSales = calculatePeriodRevenue(salesReport.adminProductsSales, 'month');
