    ...
    useEffect(() => {
        const fetchItineraries = async () => {
            try {
                ...
                const response = await axios.get('http://localhost:4000/tour-guide/itinerary', {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    }
                });
                // Set all itineraries directly without filtering by date
