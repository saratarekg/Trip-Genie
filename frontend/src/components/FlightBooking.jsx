...
function BookingPage() {
  ...
  // get currency code using GET "http://localhost:4000/tourist/currencies/code"
          ...
          <div className="flex flex-wrap gap-3 justify-between items-center">
            ...
            <Select value={priceFilter} onValueChange={setPriceFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="under500">Under 500 {currencyCode}</SelectItem>
                <SelectItem value="under1000">Under 1000 {currencyCode}</SelectItem>
                <SelectItem value="over1000">Over 1000 {currencyCode}</SelectItem>
              </SelectContent>
            </Select>
          </div>
                        ...
                        <DialogContent className="sm:max-w-[425px]">
                          ...
                          {selectedFlight && (
                            <div className="mt-4">
                              ...
                              <Button className="mt-4 w-full bg-blue-900 hover:bg-blue-800 text-white">
                                Book Now
                              </Button>
                            </div>
                          )}
