    ...
    <div className="p-4 max-w-4xl mx-auto"> 
      ...
      > 
        <DialogTrigger asChild> 
          ...
          > 
            <div className="absolute top-1/2 transform -translate-y-1/2 w-full font-medium text-black text-[32px] text-center tracking-[0] leading-[38.0px]"> 
              Manage 
              <br /> 
              Accounts 
            </div> 
              ...
              <ul className="list-none"> 
                {filteredUsers.length > 0 ? ( 
                  filteredUsers.map((user) => ( 
                    <li 
                      key={user._id} 
                      className="flex justify-between items-center py-2 text-lg bg-[#f7f7f7] rounded-lg mb-2 border border-[#808080] px-4" // Add padding here 
                    > 
                      <span className="mr-4">{user.username}</span> {/* Add margin-right for spacing */} 
                      <Button 
                        onClick={() => setConfirmDelete(user._id)} 
                        className="bg-[#ED8936] hover:bg-[#D6782D] text-white rounded-lg px-4 py-2" // Add padding for the button
                      > 
                        Delete 
                      </Button> 
                    </li> 
