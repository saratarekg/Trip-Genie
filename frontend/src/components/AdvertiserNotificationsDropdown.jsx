    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-80 p-0 bg-white" align="end">
        <div className="flex items-center justify-between border-b border-gray-200 p-4">
          <h2 className="text-lg font-semibold text-[#1A3B47]">Notifications</h2>
          <button 
        ...
        <div className="max-h-[300px] overflow-y-auto">
          {loading ? (
            ...
            <p className="text-[#1A3B47] p-4 text-center">No notifications at the moment.</p>
          ) : (
            <ul className="divide-y divide-gray-200">
              {notifications.map((notification, index) => (
                ...
                >
                  ...
                  <p className="text-[#1A3B47] mb-1 pr-16">{notification.body}</p>
