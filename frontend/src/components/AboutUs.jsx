...
export function AboutUs() {
  ...
  return (
    <div className="w-full mb-24">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-[#1A3B47] mb-8">
                Discover extraordinary journeys and unforgettable experiences with our expert travel services. We combine luxury, adventure, and comfort to create the perfect getaway for every traveler.
              </p>
            </div>
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center w-8 h-8 bg-[#F88C33] rounded-full ">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-[#1A3B47] mb-2">Safe Traveling</h3>
                  <p className="text-[#1A3B47]">Experience worry-free adventures with our comprehensive safety measures and expert local guides ensuring your security throughout the journey.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
              <div className="flex items-center justify-center w-8 h-8 bg-[#F88C33] rounded-full ">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-[#1A3B47] mb-2">Affordable Price</h3>
                  <p className="text-[#1A3B47]">Enjoy premium travel experiences at competitive prices, with transparent pricing and value-added services that maximize your travel investment.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="flex items-center justify-center w-8 h-8 bg-[#F88C33] rounded-full ">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-[#1A3B47] mb-2">Exceptional Products</h3>
                  <p className="text-[#1A3B47]">Explore our curated selection of travel products that enhance your journey, offering quality and functionality for a memorable experience.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Statistics Section */}
      <section ref={statsSectionRef} className="w-full bg-[#1A3B47] py-12">
