...
export function TestimonialBannerJsx() {
  const testimonials = [
    {
      quote:
        "This travel agency made our dream vacation a reality. The attention to detail was impeccable!",
      author: "John Smith",
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#E6DCCF] to-[#1A3B47] py-12 -mt-28 mb-16 w-screen relative left-[50%] right-[50%] ml-[-50vw] mr-[-50vw]">
      <div className="absolute inset-0 bg-gradient-to-b from-[#E6DCCF]/50 via-[#5D9297]/30 to-transparent pointer-events-none" />
      ...
      <div className="absolute top-4 left-4 w-16 h-16 border-t-4 border-l-4 border-[#F88C33] opacity-60" />
      <div className="absolute bottom-4 right-4 w-16 h-16 border-b-4 border-r-4 border-[#F88C33] opacity-60" />
    </section>
  );
}
